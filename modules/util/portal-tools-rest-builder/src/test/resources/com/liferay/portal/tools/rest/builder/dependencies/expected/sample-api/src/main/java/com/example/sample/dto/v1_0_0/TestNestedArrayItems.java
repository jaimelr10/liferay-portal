...
@GraphQLName(
	...
	value = "TestNestedArrayItems"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "TestNestedArrayItems")
public class TestNestedArrayItems implements Serializable {

	public static TestNestedArrayItems toDTO(String json) {
		return ObjectMapperUtil.readValue(TestNestedArrayItems.class, json);
	}

	public static TestNestedArrayItems unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			TestNestedArrayItems.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.example.sample.dto.v1_0_0.TestNestedArrayItems",
		name = "x-class-name"
	)
