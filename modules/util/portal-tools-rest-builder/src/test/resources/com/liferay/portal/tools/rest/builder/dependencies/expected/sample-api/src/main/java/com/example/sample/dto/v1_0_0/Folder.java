 ...
 */
@Generated("")
@GraphQLName(description = "https://www.schema.org/Folder", value = "Folder")
...
public class Folder implements Serializable {
	...
	public String toString() {
		...
		if (externalReferenceElement1s != null) {
			...
			for (int i = 0; i < externalReferenceElement1s.length; i++) {
				sb.append(externalReferenceElement1s[i]);

				if ((i + 1) < externalReferenceElement1s.length) {
					sb.append(", ");
				}
			}
		...
		if (subFolders != null) {
			...
			sb.append(String.valueOf(subFolders));
		}
