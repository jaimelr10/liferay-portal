...
public class CopyFileEntryMVCRenderCommand
	...
	public String render(
		...
		try {
			...
			if (!_dlFileEntryLocalService.canCopyFileEntry(
				...
				SessionErrors.add(
					...
					new FileEntrySizeLimitExceededException(
						_languageUtil.format(
							...
							"file-cannot-be-copied-because-it-exceeds-the-" +
								"limit-defined-in-x-Settings-x",
							_dlFileEntryLocalService.getCopyFailInfo(
								fileEntry, systemMaxSizeToCopy,
