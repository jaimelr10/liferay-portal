...
public abstract class BaseExportProcessResourceImpl
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/asset-libraries/{assetLibraryExternalReferenceCode}/export-processes/batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postAssetLibraryExportProcessBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				ExportProcess.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/export-processes/batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ExportProcess> exportProcesses,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<ExportProcess, ExportProcess, Exception>
			exportProcessUnsafeFunction = null;
		...
		if (exportProcessUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ExportProcess");
		}
	...
	@Override
	public Page<ExportProcess> read(
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<ExportProcess>,
			 UnsafeFunction<ExportProcess, ExportProcess, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ExportProcess>,
			 UnsafeConsumer<ExportProcess, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<Collection<ExportProcess>,
		 UnsafeFunction<ExportProcess, ExportProcess, Exception>, Exception>
			contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<ExportProcess>, UnsafeConsumer<ExportProcess, Exception>,
