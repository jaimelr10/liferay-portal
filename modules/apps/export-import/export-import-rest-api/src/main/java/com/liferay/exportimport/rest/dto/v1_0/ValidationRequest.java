...
public class ValidationRequest implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = ".lar file to validate"
	)
	...
	@GraphQLField(description = ".lar file to validate")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String file;

	@JsonIgnore
	private Supplier<String> _fileSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.exportimport.rest.dto.v1_0.ValidationRequest",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:572800685