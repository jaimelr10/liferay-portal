 ...
 */
@Generated("")
@GraphQLName("ProcessProgress")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ProcessProgress")
public class ProcessProgress implements Serializable {

	public static ProcessProgress toDTO(String json) {
		return ObjectMapperUtil.readValue(ProcessProgress.class, json);
	}

	public static ProcessProgress unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ProcessProgress.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The completion percentage of the process."
	)
	...
	@GraphQLField(description = "The completion percentage of the process.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Integer percentage;

	@JsonIgnore
	private Supplier<Integer> _percentageSupplier;
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.exportimport.rest.dto.v1_0.ProcessProgress",
		name = "x-class-name"
	)
