...
export default function MoveModal({items: initialItems, moveItemParentId}) {
	...
	return (
		<div className="container-fluid p-3">
			...
			{!searchActive && (
				<ClayTreeView
					defaultItems={items}
					defaultSelectedKeys={new Set([moveItemParentId])}
					nestedKey="children"
...
MoveModal.propTypes = {
	...
	moveItemParentId: PropTypes.number.isRequired,
};
